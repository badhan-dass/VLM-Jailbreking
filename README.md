# VLM-Jailbreking
This repository is the implementation of the paper **Jailbreaking Large Vision Language Models in Intelligent Transportation Systems,** which is accepted in the special session Robustness and Security of Large Language Models (ROSE-LLM) at 25th IEEE International Conference on Machine Learning and Applications (ICMLA-2025).
